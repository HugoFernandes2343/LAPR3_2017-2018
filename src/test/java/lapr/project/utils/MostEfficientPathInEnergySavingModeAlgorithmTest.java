...
VelocityLimitList velocityLimitList = new VelocityLimitList();
        ...
        MostEfficientPathInEnergySavingModeAlgorithm algorithm = new MostEfficientPathInEnergySavingModeAlgorithm();
        ...
        assertEquals(1303935.2844184162, analysis.getEnergyConsumption(), 0.1);
        ...
        assertEquals(0.5, analysis.getAceleratingAcceleration(), 0.0);
        assertEquals(22.2, analysis.getAverageVelocity(), 0.1);
        assertEquals(5517606.101411322, analysis.getEnergyConsumption(), 0.1);
        assertEquals(458.44444444444446, analysis.getTravellTime(), 0.1);
        ...
        assertEquals(0.5, analysis.getAceleratingAcceleration(), 0.0);
        assertEquals(22.2, analysis.getAverageVelocity(), 0.1);
        assertEquals(1.8046887339834876E7, analysis.getEnergyConsumption(), 0.1);

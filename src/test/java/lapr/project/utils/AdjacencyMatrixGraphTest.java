...
public class AdjacencyMatrixGraphTest {
    ...
    public void testDirectConnections() {
        ...
        assertTrue("The method should return null", instance.directConnections("Vert 1") == null);
        for (int i = 1; i <= 5; i++) {
            instance.insertVertex("Vert " + i);
        }
        
        Iterator<String> direct = instance.directConnections("Vert 1").iterator();
        
        assertTrue("Vert 1 should have 0 connections", direct.hasNext() == false);
        ...
        direct = instance.directConnections("Vert 1").iterator();
        
        assertTrue("first vertice should be \"Vert 2\"", (direct.next().compareTo("Vert 2") == 0));
        assertTrue("second vertice should be \"EVert 3\"", (direct.next().compareTo("Vert 3") == 0));
        
        instance.removeEdge("Vert 1", "Vert 2");
        
        direct = instance.directConnections("Vert 1").iterator();
        assertTrue("first vertice should be \"Vert 3\"", (direct.next().compareTo("Vert 3") == 0));
        
        instance.removeEdge("Vert 1", "Vert 3");
        direct = instance.directConnections("Vert 1").iterator();
        assertTrue("\"Vert 1\" shouldn't have direct connections", direct.hasNext() == false);
    }
    ...
    public void testOutgoingEdges() {
        ...
        Iterable<String> direct = instance.outgoingEdges("Vert 1");
        int count = 0;
        for (String s : direct) {
            count++;
        }
        assertTrue("Vert 1 should have zero connections", count == 0);
        ...
        direct = instance.outgoingEdges("Vert 1");
        
        Iterator<String> it = direct.iterator();
        
        assertEquals("Edge 1", it.next());
        assertEquals("Edge 3", it.next());
    }
    ...
    public void testClone() {
        ...
        AdjacencyMatrixGraph<String, String> instance2 = instance.clone();

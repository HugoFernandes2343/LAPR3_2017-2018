...
public class MostEfficientPathInEnergySavingModeAlgorithm implements Algorithm {
    ...
    */
     ...
     * @return
     */
    public Gear selectGear(double [] values, double acceleration, Vehicle vehicle, double vr, double angle) {
    ...
    /**
     * Setter for the accelaration value
     * @param aceleratingAcceleration 
     */
    ...
    /**
     * Setter for the braking accelaration value
     * @param brakingAcceleration 
     */
    ...
    /**
     * Calculates how much time it takes to cross a segment
     * @param segment
     * @param lastVelocity
     * @param newVelocity
     * @param acceleration
